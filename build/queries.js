    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                console.log("User Info", hashedPassword);
                //   return userInfo;
                bcrypt
                    .compare(password, hashedPassword)
                    .then(function (res) {
                    // res == true
                    console.log("respomse frpm jhased pased", res);
                })
                    .catch(function (error) {
                    throw error;
                });
...
var updateUser = function (id, name, email, password, photo) {
