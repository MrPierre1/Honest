...
var getUserTaskByTaskId = function (task_id) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, dbPool.query("SELECT * FROM user_task WHERE task_id = " + task_id)];
            case 1:
                res = _a.sent();
                console.log("res", res);
...
var getUserTaskByUserId = function (user_id) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, dbPool.query("SELECT * FROM user_task WHERE user_id = " + user_id)];
            case 1:
                res = _a.sent();
                console.log("res", res);
...
var associateUserWithTask = function (task_id, user_id) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, dbPool.query("INSERT INTO user_task (task_id, user_id) VALUES ($1, $2) returning task_id", [task_id, user_id])];
            case 1:
                res = _a.sent();
                return [2 /*return*/, results(res)];
            case 2:
...
//     const res = await dbPool.query(`DELETE FROM tasks WHERE task_id =${task_id}`);
